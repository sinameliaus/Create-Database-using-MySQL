...
-- -----------------------------------------------------
-- Table `world`.`covidstats`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `world`.`covidstats` ;

CREATE TABLE IF NOT EXISTS `world`.`covidstats` (
  `CountryCode` CHAR(3) NOT NULL DEFAULT '',
  `reportDate` DATE NOT NULL,
  `confirmedCases` INT NULL DEFAULT NULL,
  `percentagePer1000` DECIMAL(4,2) NOT NULL DEFAULT '0.00',
  `deaths` INT NULL DEFAULT NULL,
  `recoverd` INT NULL DEFAULT NULL,
  `noOfTests` INT NULL DEFAULT NULL,
  `activeCases` INT NULL DEFAULT NULL,
  PRIMARY KEY (`CountryCode`, `reportDate`),
  INDEX `CountryCode` (`CountryCode` ASC),
  CONSTRAINT `CovidStats_ibfk_2`
...
INSERT INTO `covidstats` VALUES ('AUS','2020-05-21',7081,0.28,100,6470,1137558,511),('BRA','2020-05-21',293357,1.38,18804,116683,735224,157780),('ESP','2020-05-21',279524,5.98,27888,196958,3037840,54678),('GBR','2020-05-21',248293,3.66,35704,NULL,2962227,NULL),('RUS','2020-05-21',308705,2.12,2972,85392,7578029,220341),('USA','2020-05-21',1593039,4.82,94941,370812,14173807,1127286);
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('USA', '20200522', '1620902', '4.9', '96354', '382169', '13472618', '1142379');
UPDATE `world`.`covidstats` SET `noOfTests` = '13439114' WHERE (`CountryCode` = 'USA') and (`reportDate` = '2020-05-21');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('RUS', '20200522', '317554', '2.176', '3099', '92681', '7840800', '221774');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('BRA', '20200522', '310921', '1.464', '20082', '125960', '735224', '164879');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('ESP', '20200522', '280117', '5.991', '27940', '196958', '3037840', '55219');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `noOfTests`) VALUES ('GBR', '20200522', '250908', '3.698', '36042', '3090566');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('AUS', '20200522', '7095', '2.78', '101', '6478', '1137684', '516');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('USA', '20200525', '1686436', '5.1', '99300', '451702', '14749786', '1135434');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('BRA', '20200525', '365213', '1.72', '22746', '149911', '735224', '192556');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('RUS', '20200525', '353427', '2.42', '3633', '118798', '8945384', '230996');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('ESP', '20200525', '282852', '6.05', '28752', '196985', '3556567', '57142');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `noOfTests`) VALUES ('GBR', '20200525', '259559', '3.83', '36793', '3458905');
INSERT INTO `world`.`covidstats` (`CountryCode`, `reportDate`, `confirmedCases`, `percentagePer1000`, `deaths`, `recoverd`, `noOfTests`, `activeCases`) VALUES ('AUS', '20200525', '7118', '2.79', '102', '6531', '405341', '485');
ALTER TABLE `world`.`country` 
ADD INDEX `Captial_idx` (`Capital` ASC) VISIBLE;
;
ALTER TABLE `world`.`country` 
ADD CONSTRAINT `Captial`
  FOREIGN KEY (`Capital`)
